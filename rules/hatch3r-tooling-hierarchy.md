...
**Available tools:** IDE-native browser MCP (e.g., `cursor-ide-browser` in Cursor); Playwright MCP (`@playwright/mcp`, Microsoft — `github.com/microsoft/playwright-mcp`) for cross-editor browser automation.
