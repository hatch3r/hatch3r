...
When seeking information, follow this priority order, combining sources when valuable (read the spec first, then verify external API usage with docs MCP, then check for recent advisories via web research):
