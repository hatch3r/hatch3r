...
- `minimumReleaseAge: 4320` (minutes = 3 days) and `ignore-scripts=true` per the malicious-package section below — closes the propagation window and blocks lifecycle-script execution.
