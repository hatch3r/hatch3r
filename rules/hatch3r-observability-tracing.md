...
Follow the [OpenTelemetry Semantic Conventions](https://opentelemetry.io/docs/specs/semconv/) (v1.37.0+) for consistent attribute naming across all telemetry signals.
