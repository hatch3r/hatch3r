...
5. **Cleanup window** — flags retired ≤30 days after 100% rollout per `rules/hatch3r-feature-flags.md` (which sets the max-30-day cleanup deadline; kill switches are permanent operational flags exempt from it).
