...
> Orchestration boilerplate: see `commands/shared/orchestration-frame.md` → Execute-Now Continuation. Per-command slots: artifact = `docs/specs/{NN}_{feature-slug}.md` (the Step 5 spec Step 8 wrote); revise returns to Step 4 (Synthesize & Review Research).
