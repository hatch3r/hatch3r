...
- **Currency:** AGENTS.md content is hand-edited per project; hatch3r ships canonical content (29 agents + 64 rules + 53 skills + 30 commands + 7 hooks + 10 MCP servers — see [`governance/inventory.json`](governance/inventory.json)) audited weekly across 24 governance domains.
