// DD-D3 (release/2.8.5): moved verbatim from src/cli/shared/agentsContentShared.ts
// (import-boundary Rule 1 — consumed by the bridge-orchestration domain module).
// The ui.js import below is on the sanctioned logging allowlist (D0).
// The old path is a re-export shim for one minor release.
import { readdir, readFile } from "node:fs/promises";
import { join } from "node:path";
import { parseFrontmatter } from "../canonical.js";
