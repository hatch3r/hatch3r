...
hatch3r is an open-source CLI and Cursor plugin that installs a tool-agnostic agentic coding setup into any repository — 26 agents, 49 skills, 64 rules, 24 commands, and 7 hooks generated from one canonical source. One command gives you agents, skills, rules, commands, and MCP integrations -- optimized for your coding tool of choice.
