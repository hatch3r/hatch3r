...
- **Two-axis pillar framework (2.0.0)** -- 8 governance pillars (P1-P8) plus 10 content-quality pillars (CQ1-CQ10), 9 of them owned by a specialist agent with measurable thresholds (CQ10 Product & Spec Quality's specialist is queued). See [Quality-Vector Specialists](../guides/quality-vector-specialists).
