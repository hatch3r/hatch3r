...
**Ratified posture (2026-07-12):** MIT stands, with its patent silence deliberately accepted on the low-exposure rationale above — option (a) of the previously pending disposition, ratified by the framework owner in Cycle-12 CL-1 Phase 5 (candidate C12-CL1-6) and recorded in the project's Cycle-12 disposition record (PRD §27). This closes the queued "MIT-vs-Apache licensing record" candidate. **Revisit trigger:** the decision re-opens — routing through the governance-evolution engine with explicit owner consent, as [License changes](#license-changes) states — if a patent-sensitive corporate adoption inquiry arrives, or if the contributor base grows to the point where fresh per-contributor patent grants become impractical to collect retroactively.
