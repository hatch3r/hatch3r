...
- `governance/audit/domains/D24-governance-self-audit.md` — D24-SA24.2-F11 source finding (missing ad-hoc Tier >= 2 orchestrator scaffold); accessed 2026-05-31; trust tier: official-docs (in-repo canonical).
