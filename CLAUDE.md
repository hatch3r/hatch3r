...
| `governance/` | Two-axis pillar framework (8 governance + 9 content-quality pillars), 24 audit domains, audit cycle, closed-loop phases |
...
|--------|------|-------------|----------------|
| P1 | CLI UI/UX Excellence | Actionable errors, progressive disclosure, first-run success | D10, D20.1 |
...
| `governance/CONSTITUTION.md` | Design rationale: two-axis pillar framework (8 governance + 9 content-quality pillars), traceability matrix, lean thresholds |
