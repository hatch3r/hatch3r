...
| CQ10 Product & Spec | `hatch3r-product-spec` | Spec artifacts produced or modified — `docs/specs/**`, `*.prd.md`, `requirements.md`/`design.md`/`tasks.md` triples, acceptance-criteria sections; greenfield/brownfield spec-output review; implementation PRs claiming spec coverage |
